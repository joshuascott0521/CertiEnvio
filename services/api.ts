  ...
  updateProfile: async (userData: Partial<User>): Promise<ApiResponse<User>> => {
    try {
      ...
      return {
        success: false,
        data: {} as User,
        error: error.response?.data?.message || "Error al actualizar datos del usuario",
      }
    }
  },
...
export const entityService = {
  ...
  update: async (id: number, entity: Partial<Entity>): Promise<ApiResponse<Entity>> => {
    try {
      ...
      return {
        success: false,
        data: {} as Entity,
        error: error.response?.data?.message || "Error al actualizar la entidad",
      }
    }
  },
}
